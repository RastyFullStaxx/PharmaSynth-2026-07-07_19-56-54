...
| 2 | `ferment` | Synthesis | Ferment; confirm CO2 with limewater | `prepare-must` | Yeast digests sugar to ethanol + CO2; the CO2 clouds limewater (CaCO3) — proof it works. → Pour 10 ml of limewater into Test Tube 5, then lead the delivery tube from the flask into it and watch it turn milky. |
...
| 6 | `test-iodoform` | ChemicalTests | Iodoform test (yellow precipitate) | `distill` | Ethanol gives a pale-YELLOW iodoform precipitate with KI + hypochlorite. → Test Tube 6: 1 squeeze of your distillate, 10 squeezes of potassium iodide 10%, 5 squeezes of sodium hypochlorite - then warm it at the water bath to 60 C. |
| 7 | `test-ester` | ChemicalTests | Ester formation (fruity odour) | `distill` | Ethanol + acetic acid + sulfuric acid make a sweet, fruity ESTER smell. → Test Tube 7: 10 squeezes of your distillate, 4 squeezes of diluted acetic acid, 1 squeeze of sulfuric acid - then warm it at the water bath. |
...
| 3 | `confirm-ferment` | Synthesis | Confirm fermentation - CO2 turns limewater milky | `stir-must` | Fermenting wine gives off CO2; leading that gas through limewater proves it is alive - the limewater turns milky (CaCO3). → Pour 10 ml of limewater into Test Tube 5 and hold it at the jar's mouth until it clouds - then the week-long ferment passes. |
